...
public class GlobalChatSocket {
    ...
    private static GlobalMessageRepository globalmsgRepo;
     ...
     */
    @Autowired
    public void setMessageRepository(GlobalMessageRepository repo) {
        globalmsgRepo = repo;  // we are setting the static variable
    }
    ...
    public void onMessage(Session session, String message) throws IOException {
        ...
        if (message.startsWith("@")) {
         ...
         globalmsgRepo.save(new GlobalChatMessage(username, message));
