...
public class MultipleChoiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multichoicecreator);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MultipleChoiceActivity.this, QuestionCreatorActivity.class);
    ...
    private void saveQuestion() {
        ...
        String requestBody = answer1 + "%3A" + answer2 + "%3A" + answer3 + "%3A" + answer4 + "%3A" + question;

        // Specify the URL of your backend API for creating a multiple-choice question
        String apiUrl = "http://coms-309-041.class.las.iastate.edu:8080/multiplechoicequestion/create";
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(MultipleChoiceActivity.this, "Question saved successfully", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(MultipleChoiceActivity.this, "Error saving question", Toast.LENGTH_SHORT).show();
    ...
    private void editQuestion() {
        ...
        String requestBody = id + "%3A" + answer1 + "%3A" + answer2 + "%3A" + answer3 + "%3A" + answer4 + "%3A" + question;

        // Specify the URL of your backend API for creating a multiple-choice question
        String apiUrl = "http://coms-309-041.class.las.iastate.edu:8080/multiplechoicequestion/edit";
    ...
    private void deleteQuestion() {
        ...
        if (!questionIdText.isEmpty()) {
            ...
            String apiUrl = "http://coms-309-041.class.las.iastate.edu:8080/multiplechoicequestion/" + questionId;
            ...
            StringRequest stringRequest = new StringRequest(
                    ...
                    new Response.Listener<String>() {
                        ...
                        @Override
                        public void onResponse(String response) {
                            Toast.makeText(MultipleChoiceActivity.this, "Question deleted successfully", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    },
                    new Response.ErrorListener() {
                        ...
                        @Override
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(MultipleChoiceActivity.this, "Error deleting question", Toast.LENGTH_SHORT).show();
                            error.printStackTrace();
                        }
                    }
            );
