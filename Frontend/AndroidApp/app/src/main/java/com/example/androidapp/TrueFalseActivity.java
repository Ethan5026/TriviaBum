...
public class TrueFalseActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_truefalsecreator);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TrueFalseActivity.this, QuestionCreatorActivity.class);
    ...
    String BASE_URL = "http://coms-309-041.class.las.iastate.edu:8080/";
    ...
    private void saveQuestion() {
        ...
        String requestBody = answer1 + "%3A" + answer2 + "%3A" + question;

        String apiUrl = BASE_URL + "truefalse/create";
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(TrueFalseActivity.this, "Question saved successfully", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(TrueFalseActivity.this, "Error saving question", Toast.LENGTH_SHORT).show();
    ...
    private void editQuestion() {
        ...
        String requestBody = id + "%3A" + answer1 + "%3A" + answer2 + "%3A" + question;

        // Specify the URL of your backend API for creating a multiple-choice question
        String apiUrl = BASE_URL + "truefalse/edit";
    ...
    private void deleteQuestion() {
        ...
        if (!questionIdText.isEmpty()) {
            ...
            String apiUrl = BASE_URL + "truefalse/" + questionId;
            ...
            StringRequest stringRequest = new StringRequest(
                    ...
                    new Response.Listener<String>() {
                        ...
                        @Override
                        public void onResponse(String response) {
                            Toast.makeText(TrueFalseActivity.this, "Question deleted successfully", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    },
                    new Response.ErrorListener() {
                        ...
                        @Override
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(TrueFalseActivity.this, "Error deleting question", Toast.LENGTH_SHORT).show();
                            error.printStackTrace();
                        }
                    }
            );
